...
void Water::Initialize() {
    wave[0] = (Wave){0.23f, 0.0f, 0.8f, 2.7f, 0.0f, 0.0f};
    wave[0].D = glm::vec2(-0.468f, -0.956f);

    wave[1] = (Wave){0.2f, 0.0f, 0.6f, 2.5f, 0.0f, 0.0f};
    wave[1].D = glm::vec2(-0.111f, 0.379f);

    wave[2] = (Wave){0.25f, 0.0f, 0.7f, 3.2f, 0.0f, 0.0f};
    wave[2].D = glm::vec2(0.53f, -0.239f);

    wave[3] = (Wave){0.21f, 0.0f, 0.9f, 3.0f, 0.0f, 0.0f};
