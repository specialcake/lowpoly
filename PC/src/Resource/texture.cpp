...
void Texture2D::GenerateSkymap(GLuint width, GLuint height) {
    this->Width = width, this->Height = height;
    this->Internal_Format = this->Image_Format = GL_RGBA;
...
void Texture2D::GeneratePreciseMap(GLuint width, GLuint height) {
    this->Width = width, this->Height = height;
